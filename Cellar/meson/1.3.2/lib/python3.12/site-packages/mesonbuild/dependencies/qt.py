        ...
        for m in self.requested_modules:
            ...
            if self.private_headers:
                ...
                if not os.path.isdir(mod_private_dir):
                    ...
                    # up correctly. /opt/homebrew/opt/qt/include/Qt + m_name is a
                    # symlink to /opt/homebrew/opt/qt/include, but the pkg-config
                    # file points to /opt/homebrew/Cellar/qt/x.y.z/Headers/, and
