    ...
    def __load_config_files(options: argparse.Namespace, scratch_dir: str, ftype: str) -> T.List[str]:
        ...
        for i, f in enumerate(filenames):
            ...
            if sys.platform != 'win32':
                ...
                ] + os.environ.get('XDG_DATA_DIRS', '/opt/homebrew/share:/usr/share').split(':')
                for path in paths:
...
BUILTIN_DIR_NOPREFIX_OPTIONS: T.Dict[OptionKey, T.Dict[str, str]] = {
    ...
    OptionKey('localstatedir'):  {'/usr': '/var',     '/opt/homebrew': '/var/local'},
    OptionKey('sharedstatedir'): {'/usr': '/var/lib', '/opt/homebrew': '/var/local/lib'},
    OptionKey('platlibdir', module='python'): {},
    OptionKey('purelibdir', module='python'): {},
}
