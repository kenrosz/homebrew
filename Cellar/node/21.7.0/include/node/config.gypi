...
{ 'target_defaults': {'cflags': [], 'default_configuration': 'Release', 'defines': ['NODE_OPENSSL_CONF_NAME=nodejs_conf', 'NODE_OPENSSL_CERT_STORE', 'ICU_NO_USER_DATA_OVERRIDE'], 'include_dirs': ['/opt/homebrew/opt/libuv/include', '/opt/homebrew/opt/brotli/include', '/opt/homebrew/opt/c-ares/include', '/opt/homebrew/opt/libnghttp2/include', '/opt/homebrew/opt/openssl@3/include', '/opt/homebrew/Cellar/icu4c/74.2/include'], 'libraries': ['-lz', '-L/opt/homebrew/opt/libuv/lib', '-luv', '-L/opt/homebrew/opt/brotli/lib', '-lbrotlidec', '-lbrotlienc', '-L/opt/homebrew/opt/c-ares/lib', '-lcares', '-L/opt/homebrew/opt/libnghttp2/lib', '-lnghttp2', '-L/opt/homebrew/opt/openssl@3/lib', '-lcrypto', '-lssl', '-L/opt/homebrew/Cellar/icu4c/74.2/lib', '-licui18n', '-licuuc', '-licudata']},
  'variables': { 'arm_fpu': 'neon',
                 ...
                 'node_prefix': '/opt/homebrew/Cellar/node/21.7.0',
