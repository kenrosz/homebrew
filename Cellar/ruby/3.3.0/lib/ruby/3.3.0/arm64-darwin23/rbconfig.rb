...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/homebrew/Cellar/ruby/3.3.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/homebrew/Cellar/ruby/3.3.0' '--enable-shared' '--disable-silent-rules' '--with-sitedir=/opt/homebrew/lib/ruby/site_ruby' '--with-vendordir=/opt/homebrew/lib/ruby/vendor_ruby' '--with-opt-dir=/opt/homebrew/opt/libyaml:/opt/homebrew/opt/openssl@3' '--without-gmp' 'MJIT_CC=/usr/bin/clang' 'CC=clang' 'CXX=clang++'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/homebrew/Cellar/ruby/3.3.0"
  ...
  CONFIG["DLDFLAGS"] = "-L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/openssl@3/lib -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["incflags"] = "-I/opt/homebrew/opt/libyaml/include -I/opt/homebrew/opt/openssl@3/include"
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/openssl@3/lib"
