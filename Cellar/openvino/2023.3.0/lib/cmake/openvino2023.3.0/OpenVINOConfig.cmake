...
macro(_ov_find_intel_cpu_dependencies)
    ...
    if(_OV_ENABLE_CPU_ACL)
        set(_ov_in_install_tree "${PACKAGE_PREFIX_DIR}/lib")
        if(_ov_in_install_tree)
            set_and_check(ARM_COMPUTE_LIB_DIR "${PACKAGE_PREFIX_DIR}/lib")
...
macro(_ov_find_intel_gpu_dependencies)
    ...
    if(_OV_ENABLE_ONEDNN_FOR_GPU AND NOT TARGET onednn_gpu_tgt)
        ...
        if(_ov_in_install_tree)
            ...
            set_and_check(onednn_gpu_lib_root "${PACKAGE_PREFIX_DIR}/lib")
            if(WIN32)
...
macro(_ov_find_protobuf_frontend_dependency)
    set(_OV_ENABLE_SYSTEM_PROTOBUF "ON")
    set(_OV_PROTOBUF_PACKAGE_CONFIG "")
    if(_OV_ENABLE_SYSTEM_PROTOBUF)
        _ov_find_dependency(Protobuf 3.21.12 EXACT ${_OV_PROTOBUF_PACKAGE_CONFIG})
    endif()
...
macro(_ov_find_tensorflow_frontend_dependencies)
    set(_OV_ENABLE_SYSTEM_SNAPPY "ON")
    set(_ov_snappy_lib "Snappy::snappy")
    if(_OV_ENABLE_SYSTEM_SNAPPY)
        _ov_find_dependency(Snappy 1.1.10 EXACT)
    endif()
