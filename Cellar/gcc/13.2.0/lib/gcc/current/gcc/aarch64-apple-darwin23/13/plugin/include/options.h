...
#endif
#ifdef GENERATOR_FILE
extern int flag_off_stack_trampolines;
#else
  int x_flag_off_stack_trampolines;
#define flag_off_stack_trampolines global_options.x_flag_off_stack_trampolines
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_stack_use_cumulative_args;
#else
  int x_flag_stack_use_cumulative_args;
#define flag_stack_use_cumulative_args global_options.x_flag_stack_use_cumulative_args
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int darwin_symbol_stubs;
#else
  int x_darwin_symbol_stubs;
#define darwin_symbol_stubs global_options.x_darwin_symbol_stubs
#endif
#ifdef GENERATOR_FILE
...
#define MASK_MACHO_DYNAMIC_NO_PIC (1U << 1)
#define MASK_GENERAL_REGS_ONLY (1U << 2)
...
#define TARGET_EXPLICIT_MACHO_DYNAMIC_NO_PIC_P(opts) ((opts->x_target_flags_explicit & MASK_MACHO_DYNAMIC_NO_PIC) != 0)
#define SET_TARGET_MACHO_DYNAMIC_NO_PIC(opts) opts->x_target_flags |= MASK_MACHO_DYNAMIC_NO_PIC
...
enum opt_code
{
  ...
  OPT_Wall = 455,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 456,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 457,                     /* -Walloc-zero */
  OPT_Walloca = 458,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 459,            /* -Walloca-larger-than= */
  OPT_Wampersand = 460,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 461,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 462,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 463,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 464,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 465,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 466,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 467,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 468,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 469,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 470,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 471,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 472,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 473,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 474,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 475,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 476,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_recursion = 477,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 478,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 479,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 480,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 481,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 482,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 483,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_possible_null_argument = 484,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 485,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 486,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 487,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 488,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 489,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_allocation_size = 490,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 491,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 492,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 493,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 494,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 495,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 496,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 497,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 498,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 499,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 500,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 501,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 502,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 503,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 504,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 505,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 506,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 507,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 508,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 509, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 510,                  /* -Warray-bounds= */
  OPT_Warray_compare = 511,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 512, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 513,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 514,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 515,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 516, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 517,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 518,              /* -Wattribute-warning */
  OPT_Wattributes = 519,                     /* -Wattributes */
  OPT_Wattributes_ = 520,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 521,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 522, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 523,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 524,                   /* -Wbool-compare */
  OPT_Wbool_operation = 525,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 526,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 527,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 528,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 529, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 530,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 531,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 532,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 533,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 534,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 535,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 536, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 537,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 538,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 539,               /* -Wc++23-extensions */
  /* OPT_Wc__2a_compat = 540, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 541,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 542,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 543,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 544,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 545,                 /* -Wcannot-profile */
  ...
  OPT_Wnonportable_cfstrings = 715,          /* -Wnonportable-cfstrings */
  /* OPT_Wnormalized = 716, */               /* -Wnormalized */
  OPT_Wnormalized_ = 717,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 718,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 719,                /* -Wobjc-root-class */
  OPT_Wodr = 720,                            /* -Wodr */
  OPT_Wold_style_cast = 721,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 722,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 723,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 724,            /* -Wopenacc-parallelism */
  OPT_Wopenmp_simd = 725,                    /* -Wopenmp-simd */
  OPT_Woverflow = 726,                       /* -Woverflow */
  OPT_Woverlength_strings = 727,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 728, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 729,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 730,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 731,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 732,            /* -Woverwrite-recursive */
  OPT_Wp_ = 733,                             /* -Wp, */
  OPT_Wpacked = 734,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 735,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 736,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 737,                         /* -Wpadded */
  OPT_Wparentheses = 738,                    /* -Wparentheses */
  OPT_Wpedantic = 739,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 740,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 741,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 742,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 743, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 744,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 745,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 746,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 747,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 748,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 749,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 750,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 751,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 752,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 753,                       /* -Wprotocol */
  OPT_Wpsabi = 754,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 755,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 756,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 757,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 758,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 759,                /* -Wredundant-decls */
  OPT_Wredundant_move = 760,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 761,                 /* -Wredundant-tags */
  OPT_Wregister = 762,                       /* -Wregister */
  OPT_Wreorder = 763,                        /* -Wreorder */
  OPT_Wrestrict = 764,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 765,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 766,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 767,           /* -Wscalar-storage-order */
  OPT_Wselector = 768,                       /* -Wselector */
  OPT_Wself_move = 769,                      /* -Wself-move */
  OPT_Wsequence_point = 770,                 /* -Wsequence-point */
  OPT_Wshadow = 771,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 772, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 773,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 774, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 775,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 776, */            /* -Wshadow=global */
  OPT_Wshadow_local = 777,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 778,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 779,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 780,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 781, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 782,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 783,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 784,                /* -Wsign-conversion */
  OPT_Wsign_promo = 785,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 786,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 787,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 788,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 789,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 790,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 791,                    /* -Wspeculative */
  OPT_Wstack_protector = 792,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 793,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 794,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 795,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 796,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 797,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 798,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 799,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 800,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 801,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 802,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 803, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 804,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 805,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 806,            /* -Wstringop-truncation */
  OPT_Wstyle = 807,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 808,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 809,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 810,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 811,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 812,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 813,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 814,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 815,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 816,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 817,               /* -Wsuggest-override */
  OPT_Wsurprising = 818,                     /* -Wsurprising */
  OPT_Wswitch = 819,                         /* -Wswitch */
  OPT_Wswitch_bool = 820,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 821,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 822,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 823,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 824,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 825,                      /* -Wsync-nand */
  OPT_Wsynth = 826,                          /* -Wsynth */
  OPT_Wsystem_headers = 827,                 /* -Wsystem-headers */
  OPT_Wtabs = 828,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 829,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 830,           /* -Wtautological-compare */
  OPT_Wtemplates = 831,                      /* -Wtemplates */
  OPT_Wterminate = 832,                      /* -Wterminate */
  OPT_Wtraditional = 833,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 834,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 835,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 836,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 837,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 838,                           /* -Wtsan */
  OPT_Wtype_limits = 839,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 840,            /* -Wundeclared-selector */
  OPT_Wundef = 841,                          /* -Wundef */
  OPT_Wundefined_do_loop = 842,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 843,                      /* -Wunderflow */
  OPT_Wunicode = 844,                        /* -Wunicode */
  OPT_Wuninitialized = 845,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 846,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 847, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 848, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 849,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 850,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 851,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 852,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 853, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 854,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 855,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 856,                /* -Wunused-function */
  OPT_Wunused_label = 857,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 858,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 859,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 860,               /* -Wunused-parameter */
  OPT_Wunused_result = 861,                  /* -Wunused-result */
  OPT_Wunused_value = 862,                   /* -Wunused-value */
  OPT_Wunused_variable = 863,                /* -Wunused-variable */
  OPT_Wuse_after_free = 864,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 865,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 866,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 867,                   /* -Wuseless-cast */
  OPT_Wvarargs = 868,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 869,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 870,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 871,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 872,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 873,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 874,            /* -Wvirtual-move-assign */
  OPT_Wvla = 875,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 876,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 877,                  /* -Wvla-parameter */
  OPT_Wvolatile = 878,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 879,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 880,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 881,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 882,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 883,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 884,                       /* -Wzerotrip */
  OPT_X = 885,                               /* -X */
  OPT_Xassembler = 886,                      /* -Xassembler */
  OPT_Xf = 887,                              /* -Xf */
  OPT_Xlinker = 888,                         /* -Xlinker */
  OPT_Xpreprocessor = 889,                   /* -Xpreprocessor */
  OPT_Z = 890,                               /* -Z */
  OPT_all_load = 891,                        /* -all_load */
  OPT_allowable_client = 892,                /* -allowable_client */
  OPT_ansi = 893,                            /* -ansi */
  OPT_arch = 894,                            /* -arch */
  OPT_arch_errors_fatal = 895,               /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 896,         /* -asm_macosx_version_min= */
  OPT_aux_info = 897,                        /* -aux-info */
  /* OPT_aux_info_ = 898, */                 /* -aux-info= */
  OPT_bind_at_load = 899,                    /* -bind_at_load */
  OPT_bundle = 900,                          /* -bundle */
  OPT_bundle_loader = 901,                   /* -bundle_loader */
  OPT_c = 902,                               /* -c */
  OPT_callgraph = 903,                       /* -callgraph */
  OPT_client_name = 904,                     /* -client_name */
  OPT_compatibility_version = 905,           /* -compatibility_version */
  OPT_coverage = 906,                        /* -coverage */
  OPT_cpp = 907,                             /* -cpp */
  OPT_cpp_ = 908,                            /* -cpp= */
  OPT_current_version = 909,                 /* -current_version */
  OPT_d = 910,                               /* -d */
  OPT_dead_strip = 911,                      /* -dead_strip */
  OPT_debuglib_ = 912,                       /* -debuglib= */
  OPT_defaultlib_ = 913,                     /* -defaultlib= */
  OPT_defined_only = 914,                    /* -defined-only */
  OPT_demangle = 915,                        /* -demangle */
  /* OPT_dependency_file = 916, */           /* -dependency-file */
  OPT_dstartfiles = 917,                     /* -dstartfiles */
  OPT_dump_body_ = 918,                      /* -dump-body= */
  OPT_dump_level_ = 919,                     /* -dump-level= */
  OPT_dumpbase = 920,                        /* -dumpbase */
  OPT_dumpbase_ext = 921,                    /* -dumpbase-ext */
  OPT_dumpdir = 922,                         /* -dumpdir */
  OPT_dumpfullversion = 923,                 /* -dumpfullversion */
  OPT_dumpmachine = 924,                     /* -dumpmachine */
  OPT_dumpspecs = 925,                       /* -dumpspecs */
  OPT_dumpversion = 926,                     /* -dumpversion */
  OPT_dylib_file = 927,                      /* -dylib_file */
  OPT_dylinker = 928,                        /* -dylinker */
  OPT_dylinker_install_name = 929,           /* -dylinker_install_name */
  OPT_dynamic = 930,                         /* -dynamic */
  OPT_dynamiclib = 931,                      /* -dynamiclib */
  OPT_e = 932,                               /* -e */
  OPT_export_dynamic = 933,                  /* -export-dynamic */
  OPT_exported_symbols_list = 934,           /* -exported_symbols_list */
  OPT_fPIC = 935,                            /* -fPIC */
  OPT_fPIE = 936,                            /* -fPIE */
  OPT_fRTS_ = 937,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 938,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 939,                   /* -fabi-version= */
  OPT_faccess_control = 940,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 941,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 942,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 943,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 944,                  /* -falign-commons */
  OPT_falign_functions = 945,                /* -falign-functions */
  OPT_falign_functions_ = 946,               /* -falign-functions= */
  OPT_falign_jumps = 947,                    /* -falign-jumps */
  OPT_falign_jumps_ = 948,                   /* -falign-jumps= */
  OPT_falign_labels = 949,                   /* -falign-labels */
  OPT_falign_labels_ = 950,                  /* -falign-labels= */
  OPT_falign_loops = 951,                    /* -falign-loops */
  OPT_falign_loops_ = 952,                   /* -falign-loops= */
  /* OPT_faligned_new = 953, */              /* -faligned-new */
  OPT_faligned_new_ = 954,                   /* -faligned-new= */
  OPT_fall_instantiations = 955,             /* -fall-instantiations */
  OPT_fall_intrinsics = 956,                 /* -fall-intrinsics */
  OPT_fall_virtual = 957,                    /* -fall-virtual */
  OPT_fallocation_dce = 958,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 959,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 960,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 961,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 962, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 963,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 964,         /* -falt-external-templates */
  OPT_fanalyzer = 965,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 966,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 967,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 968,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 969,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 970,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 971,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 972,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 973,    /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 974,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 975,         /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 976,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 977, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 978,            /* -fanalyzer-verbosity= */
  OPT_fapple_kext = 979,                     /* -fapple-kext */
  /* OPT_fargument_alias = 980, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 981, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 982, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 983, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 984,            /* -fasan-shadow-offset= */
  OPT_fasm = 985,                            /* -fasm */
  OPT_fassert = 986,                         /* -fassert */
  OPT_fassociative_math = 987,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 988,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 989,                   /* -fauto-inc-dec */
  OPT_fauto_init = 990,                      /* -fauto-init */
  OPT_fauto_profile = 991,                   /* -fauto-profile */
  OPT_fauto_profile_ = 992,                  /* -fauto-profile= */
  OPT_fautomatic = 993,                      /* -fautomatic */
  OPT_fbackslash = 994,                      /* -fbackslash */
  OPT_fbacktrace = 995,                      /* -fbacktrace */
  OPT_fbit_tests = 996,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 997,             /* -fblas-matmul-limit= */
  OPT_fbounds = 998,                         /* -fbounds */
  OPT_fbounds_check = 999,                   /* -fbounds-check */
  OPT_fbounds_check_ = 1000,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1001,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1002,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1003, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1004, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1005, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1006,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1007,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1008,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1009,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1010,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1011,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1012,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1013,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1014,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1015,                    /* -fcall-used- */
  OPT_fcaller_saves = 1016,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1017,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1018,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1019,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1020,      /* -fcanonical-system-headers */
  OPT_fcase = 1021,                          /* -fcase */
  /* OPT_fcf_protection = 1022, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1023,                /* -fcf-protection= */
  OPT_fchar8_t = 1024,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1025,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1026, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1027,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1028,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1029,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1030, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1031, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1032, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1033, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1034, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1035, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1036,                  /* -fcheckaction= */
  OPT_fchecking = 1037,                      /* -fchecking */
  OPT_fchecking_ = 1038,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1039,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1040,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1041,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1042,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1043,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1044,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1045,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1046,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1047,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1048,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1049,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1050,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1051,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1052,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1053,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1054,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1055,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1056,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1057, */                /* -fcilkplus */
  OPT_fcoarray_ = 1058,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1059,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1060,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1061,                        /* -fcommon */
  OPT_fcompare_debug = 1062,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1063,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1064,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1065,                  /* -fcompare-elim */
  OPT_fconcepts = 1066,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1067,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1068,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1069,                 /* -fcond-mismatch */
  /* OPT_fconserve_space = 1070, */          /* -fconserve-space */
  OPT_fconserve_stack = 1071,                /* -fconserve-stack */
  /* OPT_fconstant_cfstrings = 1072, */      /* -fconstant-cfstrings */
  OPT_fconstant_string_class_ = 1073,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1074,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1075,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1076,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1077,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1078,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1079,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1080,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1081,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1082,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1083,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1084,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1085, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1086,                     /* -fcontracts */
  OPT_fconvert_ = 1087,                      /* -fconvert= */
  OPT_fcoroutines = 1088,                    /* -fcoroutines */
  OPT_fcpp = 1089,                           /* -fcpp */
  OPT_fcpp_begin = 1090,                     /* -fcpp-begin */
  OPT_fcpp_end = 1091,                       /* -fcpp-end */
  OPT_fcprop_registers = 1092,               /* -fcprop-registers */
  OPT_fcray_pointer = 1093,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1094,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1095,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1096, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1097,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1098,              /* -fcx-limited-range */
  OPT_fd = 1099,                             /* -fd */
  OPT_fd_lines_as_code = 1100,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1101,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1102,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1103,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1104,                      /* -fdbg-cnt= */
  OPT_fdce = 1105,                           /* -fdce */
  OPT_fdebug = 1106,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1107,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1108,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1109,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1110,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1111,             /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 1112,               /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 1113,              /* -fdebug-trace-quad */
  OPT_fdebug_types_section = 1114,           /* -fdebug-types-section */
  OPT_fdebug_ = 1115,                        /* -fdebug= */
  OPT_fdec = 1116,                           /* -fdec */
  OPT_fdec_blank_format_item = 1117,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1118,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1119,           /* -fdec-format-defaults */
  OPT_fdec_include = 1120,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1121,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1122,                      /* -fdec-math */
  OPT_fdec_static = 1123,                    /* -fdec-static */
  OPT_fdec_structure = 1124,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1125,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1126, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1127,                          /* -fdef= */
  OPT_fdefault_double_8 = 1128,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1129, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1130,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1131,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1132,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1133,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1134,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1135,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1136,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1137,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1138,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1139,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1140,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1141, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1142,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1143,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1144,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1145,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1146,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1147,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1148,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1149,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1150,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1151,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1152,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1153,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1154,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1155, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1156,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1157,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1158,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1159,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1160,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1161,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1162,               /* -fdirectives-only */
  OPT_fdisable_ = 1163,                      /* -fdisable- */
  OPT_fdoc = 1164,                           /* -fdoc */
  OPT_fdoc_dir_ = 1165,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1166,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1167,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1168,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1169,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1170,                      /* -fdruntime */
  OPT_fdse = 1171,                           /* -fdse */
  OPT_fdump_ = 1172,                         /* -fdump- */
  OPT_fdump_ada_spec = 1173,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1174,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1175,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1176,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1177,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1178,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1179,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1180,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1181,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1182,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1183,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1184,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1185,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1186,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1187,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1188,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1189,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1190, */               /* -fdump-core */
  OPT_fdump_d_original = 1191,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1192,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1193,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1194,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1195,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1196,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1197,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1198,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1199,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1200, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1201,                   /* -fdump-passes */
  OPT_fdump_scos = 1202,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1203,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1204,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1205,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1206,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1207,                /* -fearly-inlining */
  OPT_felide_constructors = 1208,            /* -felide-constructors */
  OPT_felide_type = 1209,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1210, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1211,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1212,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1213,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1214,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1215,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1216,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1217,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1218,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1219,                /* -fenum-int-equiv */
  OPT_fexceptions = 1220,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1221,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1222,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1223,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1224,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1225,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1226,               /* -fextended-opaque */
  OPT_fextern_std_ = 1227,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1228,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1229,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1230,            /* -fexternal-templates */
  OPT_ff2c = 1231,                           /* -ff2c */
  OPT_ffast_math = 1232,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1233,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1234,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1235,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1236,              /* -ffinite-math-only */
  OPT_ffixed_ = 1237,                        /* -ffixed- */
  OPT_ffixed_form = 1238,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1239,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1240,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1241,                   /* -ffloat-store */
  OPT_ffloatvalue = 1242,                    /* -ffloatvalue */
  OPT_ffold_simple_inlines = 1243,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1244,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1245, */              /* -fforce-addr */
  OPT_fforward_propagate = 1246,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1247,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1248,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1249,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1250,                     /* -ffpe-trap= */
  OPT_ffree_form = 1251,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1252,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1253,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1254,                  /* -ffreestanding */
  OPT_ffriend_injection = 1255,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1256,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1257,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1258,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1259,             /* -ffunction-sections */
  OPT_fgcse = 1260,                          /* -fgcse */
  OPT_fgcse_after_reload = 1261,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1262,                      /* -fgcse-las */
  OPT_fgcse_lm = 1263,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1264,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1265,              /* -fgen-module-list= */
  OPT_fgimple = 1266,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1267,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1268,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1269,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1270,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1271,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1272,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1273,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1274,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1275,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1276,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1277,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1278,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1279,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1280,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1281,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1282,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1283,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1284,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1285,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1286,                      /* -fgraphite */
  OPT_fgraphite_identity = 1287,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1288,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1289,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1290, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1291,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1292,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1293, */                    /* -fhelp */
  /* OPT_fhelp_ = 1294, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1295,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1296,                     /* -fhonor-std */
  OPT_fhosted = 1297,                        /* -fhosted */
  OPT_fhuge_objects = 1298,                  /* -fhuge-objects */
  OPT_fident = 1299,                         /* -fident */
  OPT_fif_conversion = 1300,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1301,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1302,        /* -fignore-unknown-pragmas */
  OPT_filelist = 1303,                       /* -filelist */
  OPT_fimplement_inlines = 1304,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1305,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1306,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1307,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1308,            /* -fimplicit-templates */
  OPT_findex = 1309,                         /* -findex */
  OPT_findirect_inlining = 1310,             /* -findirect-inlining */
  OPT_findirect_virtual_calls = 1311,        /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 1312,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1313,               /* -finit-character= */
  OPT_finit_derived = 1314,                  /* -finit-derived */
  OPT_finit_integer_ = 1315,                 /* -finit-integer= */
  OPT_finit_local_zero = 1316,               /* -finit-local-zero */
  OPT_finit_logical_ = 1317,                 /* -finit-logical= */
  OPT_finit_real_ = 1318,                    /* -finit-real= */
  OPT_finline = 1319,                        /* -finline */
  OPT_finline_arg_packing = 1320,            /* -finline-arg-packing */
  OPT_finline_atomics = 1321,                /* -finline-atomics */
  OPT_finline_functions = 1322,              /* -finline-functions */
  OPT_finline_functions_called_once = 1323,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1324, */           /* -finline-limit- */
  OPT_finline_limit_ = 1325,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1326,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1327,        /* -finline-small-functions */
  OPT_finput_charset_ = 1328,                /* -finput-charset= */
  OPT_finstrument_functions = 1329,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1330,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1331,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1332,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1333,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1334,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1335,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1336,                    /* -finvariants */
  OPT_fipa_bit_cp = 1337,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1338,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1339, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1340,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1341,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1342,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1343,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1344, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1345,                    /* -fipa-modref */
  OPT_fipa_profile = 1346,                   /* -fipa-profile */
  OPT_fipa_pta = 1347,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1348,                /* -fipa-pure-const */
  OPT_fipa_ra = 1349,                        /* -fipa-ra */
  OPT_fipa_reference = 1350,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1351,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1352,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1353,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1354,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1355, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1356,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1357,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1358,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1359,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1360,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1361,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1362,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1363,                  /* -fira-verbose= */
  OPT_fiso = 1364,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1365,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1366,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1367,              /* -fivar-visibility= */
  OPT_fivopts = 1368,                        /* -fivopts */
  OPT_fjump_tables = 1369,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1370,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1371,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1372,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1373,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1374,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1375,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1376,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1377,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1378,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1379,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1380,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1381,            /* -flarge-source-files */
  OPT_flat_namespace = 1382,                 /* -flat_namespace */
  OPT_flax_vector_conversions = 1383,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1384,            /* -fleading-underscore */
  OPT_flibs_ = 1385,                         /* -flibs= */
  OPT_flifetime_dse = 1386,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1387,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1388,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1389,                /* -flinker-output= */
  /* OPT_flive_patching = 1390, */           /* -flive-patching */
  OPT_flive_patching_ = 1391,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1392,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1393,                   /* -flocal-ivars */
  OPT_flocation_ = 1394,                     /* -flocation= */
  /* OPT_floop_block = 1395, */              /* -floop-block */
  /* OPT_floop_flatten = 1396, */            /* -floop-flatten */
  OPT_floop_interchange = 1397,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1398,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1399, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1400,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1401, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1402,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1403,                     /* -flra-remat */
  OPT_flto = 1404,                           /* -flto */
  OPT_flto_compression_level_ = 1405,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1406, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1407,                /* -flto-partition= */
  OPT_flto_report = 1408,                    /* -flto-report */
  OPT_flto_report_wpa = 1409,                /* -flto-report-wpa */
  OPT_flto_ = 1410,                          /* -flto= */
  OPT_fltrans = 1411,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1412,           /* -fltrans-output-list= */
  OPT_fm2_g = 1413,                          /* -fm2-g */
  OPT_fm2_lower_case = 1414,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1415,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1416,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1417,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1418,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1419,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1420,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1421,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1422,             /* -fmacro-prefix-map= */
  OPT_fmain = 1423,                          /* -fmain */
  OPT_fmath_errno = 1424,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1425,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1426,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1427,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1428,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1429,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1430,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1431,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1432,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1433,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1434,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1435,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1436,               /* -fmessage-length= */
  OPT_fmod_ = 1437,                          /* -fmod= */
  OPT_fmodule_file_ = 1438,                  /* -fmodule-file= */
  OPT_fmodule_header = 1439,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1440,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1441,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1442,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1443,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1444,                   /* -fmodule-only */
  OPT_fmodule_private = 1445,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1446,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1447,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1448,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1449,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1450,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1451,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1452,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1453,                 /* -fms-extensions */
  OPT_fmudflap = 1454,                       /* -fmudflap */
  OPT_fmudflapir = 1455,                     /* -fmudflapir */
  OPT_fmudflapth = 1456,                     /* -fmudflapth */
  OPT_fmultiflags = 1457,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1458,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1459,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1460,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1461,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1462,                  /* -fnext-runtime */
  OPT_fnil = 1463,                           /* -fnil */
  OPT_fnil_receivers = 1464,                 /* -fnil-receivers */
  OPT_fno_modules = 1465,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1466,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1467,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1468,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1469,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1470,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1471,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1472,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1473,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1474,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1475,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1476,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1477,                /* -fobjc-std=objc1 */
  OPT_foff_stack_trampolines = 1478,         /* -foff-stack-trampolines */
  OPT_foffload_abi_ = 1479,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1480,              /* -foffload-options= */
  OPT_foffload_ = 1481,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1482,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1483,                         /* -fonly= */
  OPT_fopenacc = 1484,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1485,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1486,                        /* -fopenmp */
  OPT_fopenmp_simd = 1487,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1488, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1489,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1490,                /* -foperator-names */
  OPT_fopt_info = 1491,                      /* -fopt-info */
  OPT_fopt_info_ = 1492,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1493, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1494,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1495,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1496, */          /* -foptional-diags */
  OPT_force_cpusubtype_ALL = 1497,           /* -force_cpusubtype_ALL */
  OPT_force_flat_namespace = 1498,           /* -force_flat_namespace */
  OPT_fpack_derived = 1499,                  /* -fpack-derived */
  OPT_fpack_struct = 1500,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1501,                  /* -fpack-struct= */
  OPT_fpad_source = 1502,                    /* -fpad-source */
  OPT_fpartial_inlining = 1503,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1504,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1505,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1506,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1507,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1508,                    /* -fpeel-loops */
  OPT_fpeephole = 1509,                      /* -fpeephole */
  OPT_fpeephole2 = 1510,                     /* -fpeephole2 */
  OPT_fpermissive = 1511,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1512,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1513,                           /* -fpic */
  OPT_fpie = 1514,                           /* -fpie */
  OPT_fpim = 1515,                           /* -fpim */
  OPT_fpim2 = 1516,                          /* -fpim2 */
  OPT_fpim3 = 1517,                          /* -fpim3 */
  OPT_fpim4 = 1518,                          /* -fpim4 */
  OPT_fplan9_extensions = 1519,              /* -fplan9-extensions */
  OPT_fplt = 1520,                           /* -fplt */
  OPT_fplugin_arg_ = 1521,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1522,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1523,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1524,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1525,                /* -fpostconditions */
  OPT_fpre_include_ = 1526,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1527,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1528,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1529,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1530,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1531,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1532,              /* -fpretty-templates */
  OPT_fpreview_all = 1533,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1534,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1535,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1536,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1537,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1538,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1539,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1540,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1541,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1542,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1543,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1544,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1545,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1546,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1547,           /* -fprintf-return-value */
  OPT_fprofile = 1548,                       /* -fprofile */
  OPT_fprofile_abs_path = 1549,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1550,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1551,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1552,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1553,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1554,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1555,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1556,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1557,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1558,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1559,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1560,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1561,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1562,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1563,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1564,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1565,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1566,               /* -fprofile-update= */
  OPT_fprofile_use = 1567,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1568,                  /* -fprofile-use= */
  OPT_fprofile_values = 1569,                /* -fprofile-values */
  OPT_fprotect_parens = 1570,                /* -fprotect-parens */
  OPT_fpthread = 1571,                       /* -fpthread */
  OPT_fq = 1572,                             /* -fq */
  OPT_framework = 1573,                      /* -framework */
  OPT_frandom_seed = 1574,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1575,                  /* -frandom-seed= */
  OPT_frange = 1576,                         /* -frange */
  OPT_frange_check = 1577,                   /* -frange-check */
  OPT_freal_4_real_10 = 1578,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1579,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1580,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1581,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1582,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1583,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1584,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1585,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1586,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1587,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1588,               /* -frecord-marker=8 */
  OPT_frecursive = 1589,                     /* -frecursive */
  OPT_free = 1590,                           /* -free */
  OPT_freg_struct_return = 1591,             /* -freg-struct-return */
  /* OPT_fregmove = 1592, */                 /* -fregmove */
  OPT_frelease = 1593,                       /* -frelease */
  OPT_frename_registers = 1594,              /* -frename-registers */
  OPT_freorder_blocks = 1595,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1596,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1597,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1598,             /* -freorder-functions */
  OPT_frepack_arrays = 1599,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1600,          /* -freplace-objc-classes */
  OPT_frepo = 1601,                          /* -frepo */
  OPT_freport_bug = 1602,                    /* -freport-bug */
  OPT_frequire_return_statement = 1603,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1604,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1605, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1606,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1607,                   /* -fresolution= */
  OPT_freturn = 1608,                        /* -freturn */
  OPT_frevert_all = 1609,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1610,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1611,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1612,             /* -frevert=intpromote */
  OPT_frounding_math = 1613,                 /* -frounding-math */
  OPT_frtti = 1614,                          /* -frtti */
  OPT_fruntime_modules_ = 1615,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1616,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1617,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1618,                   /* -frust-crate= */
  OPT_frust_debug = 1619,                    /* -frust-debug */
  OPT_frust_dump_ = 1620,                    /* -frust-dump- */
  OPT_frust_edition_ = 1621,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1622,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1623,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1624,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1625,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1626,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1627,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1628,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1629,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1630,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1631,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1632,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1633,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1634, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1635,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1636,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1637,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1638,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1639,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1640,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1641,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1642,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1643, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1644,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1645,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1646,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1647,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1648,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1649,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1650,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1651,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1652,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1653,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1654,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1655,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1656,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1657,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1658,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1659,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1660, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1661,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1662,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1663,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1664,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1665,               /* -fsection-anchors */
  /* OPT_fsee = 1666, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1667,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1668,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1669,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1670,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1671,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1672,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1673,        /* -fsemantic-interposition */
  OPT_fshared = 1674,                        /* -fshared */
  OPT_fshort_enums = 1675,                   /* -fshort-enums */
  OPT_fshort_wchar = 1676,                   /* -fshort-wchar */
  OPT_fshow_column = 1677,                   /* -fshow-column */
  OPT_fshrink_wrap = 1678,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1679,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1680,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1681,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1682,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1683,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1684,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1685,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1686,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1687,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1688,                /* -fsoft-check-all */
  OPT_fsources = 1689,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1690,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1691,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1692,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1693,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1694,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1695,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1696,                      /* -fsquangle */
  OPT_fssa_backprop = 1697,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1698,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1699,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1700,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1701, */             /* -fstack-check */
  OPT_fstack_check_ = 1702,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1703,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1704,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1705,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1706,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1707,               /* -fstack-protector */
  OPT_fstack_protector_all = 1708,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1709,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1710,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1711,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1712,                   /* -fstack-usage */
  OPT_fstack_use_cumulative_args = 1713,     /* -fstack-use-cumulative-args */
  OPT_fstats = 1714,                         /* -fstats */
  OPT_fstdarg_opt = 1715,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1716,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1717, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1718,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1719,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1720, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1721,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1722,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1723,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1724,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1725, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1726,            /* -fstrong-eval-order= */
  OPT_fswig = 1727,                          /* -fswig */
  OPT_fswitch_errors = 1728,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1729,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1730,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1731,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1732, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1733,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1734, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1735,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1736, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1737,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1738,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1739,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1740,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1741,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1742,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1743,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1744,                   /* -ftime-report */
  OPT_ftime_report_details = 1745,           /* -ftime-report-details */
  OPT_ftls_model_ = 1746,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1747,              /* -ftoplevel-reorder */
  OPT_ftracer = 1748,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1749,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1750,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1751,                   /* -ftrampolines */
  OPT_ftransition_all = 1752,                /* -ftransition=all */
  OPT_ftransition_field = 1753,              /* -ftransition=field */
  OPT_ftransition_in = 1754,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1755,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1756,          /* -ftransition=templates */
  OPT_ftransition_tls = 1757,                /* -ftransition=tls */
  OPT_ftrapping_math = 1758,                 /* -ftrapping-math */
  OPT_ftrapv = 1759,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1760,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1761,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1762,                      /* -ftree-ccp */
  OPT_ftree_ch = 1763,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1764, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1765,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1766,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1767, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1768,                   /* -ftree-cselim */
  OPT_ftree_dce = 1769,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1770,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1771,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1772,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1773,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1774, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1775,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1776,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1777, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1778,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1779,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1780, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1781,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1782,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1783,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1784,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1785,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1786,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1787,                      /* -ftree-pre */
  OPT_ftree_pta = 1788,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1789,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1790, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1791,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1792,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1793,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1794,                     /* -ftree-slsr */
  OPT_ftree_sra = 1795,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1796, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1797, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1798,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1799,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1800,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1801, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1802,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1803, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1804,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1805,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1806,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1807,         /* -funconstrained-commons */
  OPT_funderscoring = 1808,                  /* -funderscoring */
  OPT_funit_at_a_time = 1809,                /* -funit-at-a-time */
  OPT_funittest = 1810,                      /* -funittest */
  OPT_funreachable_traps = 1811,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1812,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1813,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1814,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1815, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1816,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1817,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1818,                 /* -funsigned-char */
  OPT_funswitch_loops = 1819,                /* -funswitch-loops */
  OPT_funwind_tables = 1820,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1821,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1822,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1823,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1824,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1825,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1826,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1827,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1828,                     /* -fuse-list= */
  OPT_fvar_tracking = 1829,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1830,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1831,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1832,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1833,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1834, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1835,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1836,                   /* -fverbose-asm */
  /* OPT_fversion = 1837, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1838,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1839,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1840,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1841,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1842,                   /* -fvisibility= */
  OPT_fvpt = 1843,                           /* -fvpt */
  OPT_fvtable_gc = 1844,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1845,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1846,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1847,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1848,                     /* -fvtv-debug */
  OPT_fweak = 1849,                          /* -fweak */
  OPT_fweak_templates = 1850,                /* -fweak-templates */
  OPT_fweb = 1851,                           /* -fweb */
  /* OPT_fwhole_file = 1852, */              /* -fwhole-file */
  OPT_fwhole_program = 1853,                 /* -fwhole-program */
  OPT_fwholediv = 1854,                      /* -fwholediv */
  OPT_fwholevalue = 1855,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1856,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1857,             /* -fworking-directory */
  OPT_fwpa = 1858,                           /* -fwpa */
  OPT_fwpa_ = 1859,                          /* -fwpa= */
  OPT_fwrapv = 1860,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1861,                 /* -fwrapv-pointer */
  OPT_fxref = 1862,                          /* -fxref */
  /* OPT_fzee = 1863, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1864,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1865,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1866,                     /* -fzero-link */
  OPT_g = 1867,                              /* -g */
  OPT_gant = 1868,                           /* -gant */
  OPT_gas_loc_support = 1869,                /* -gas-loc-support */
  OPT_gas_locview_support = 1870,            /* -gas-locview-support */
  OPT_gbtf = 1871,                           /* -gbtf */
  OPT_gcoff = 1872,                          /* -gcoff */
  OPT_gcoff1 = 1873,                         /* -gcoff1 */
  OPT_gcoff2 = 1874,                         /* -gcoff2 */
  OPT_gcoff3 = 1875,                         /* -gcoff3 */
  OPT_gcolumn_info = 1876,                   /* -gcolumn-info */
  OPT_gctf = 1877,                           /* -gctf */
  OPT_gdescribe_dies = 1878,                 /* -gdescribe-dies */
  OPT_gdwarf = 1879,                         /* -gdwarf */
  OPT_gdwarf_ = 1880,                        /* -gdwarf- */
  OPT_gdwarf32 = 1881,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1882,                       /* -gdwarf64 */
  OPT_gen_decls = 1883,                      /* -gen-decls */
  OPT_gfull = 1884,                          /* -gfull */
  OPT_ggdb = 1885,                           /* -ggdb */
  OPT_ggnu_pubnames = 1886,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1887,                   /* -gimple-stats */
  OPT_ginline_points = 1888,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1889, /* -ginternal-reset-location-views */
  OPT_gnat = 1890,                           /* -gnat */
  OPT_gnatO = 1891,                          /* -gnatO */
  OPT_gno_ = 1892,                           /* -gno- */
  OPT_gno_pubnames = 1893,                   /* -gno-pubnames */
  OPT_gpubnames = 1894,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1895,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1896,                   /* -gsplit-dwarf */
  OPT_gstabs = 1897,                         /* -gstabs */
  OPT_gstabs_ = 1898,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1899,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1900,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1901,                        /* -gtoggle */
  OPT_gused = 1902,                          /* -gused */
  OPT_gvariable_location_views = 1903,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1904,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1905,                           /* -gvms */
  OPT_gxcoff = 1906,                         /* -gxcoff */
  OPT_gxcoff_ = 1907,                        /* -gxcoff+ */
  OPT_gz = 1908,                             /* -gz */
  OPT_gz_ = 1909,                            /* -gz= */
  OPT_h = 1910,                              /* -h */
  OPT_headerpad_max_install_names = 1911,    /* -headerpad_max_install_names */
  OPT_help = 1912,                           /* -help */
  OPT_idirafter = 1913,                      /* -idirafter */
  OPT_iframework = 1914,                     /* -iframework */
  OPT_imacros = 1915,                        /* -imacros */
  OPT_image_base = 1916,                     /* -image_base */
  OPT_imultiarch = 1917,                     /* -imultiarch */
  OPT_imultilib = 1918,                      /* -imultilib */
  OPT_include = 1919,                        /* -include */
  OPT_init = 1920,                           /* -init */
  OPT_install_name = 1921,                   /* -install_name */
  OPT_iplugindir_ = 1922,                    /* -iplugindir= */
  OPT_iprefix = 1923,                        /* -iprefix */
  OPT_iquote = 1924,                         /* -iquote */
  OPT_isysroot = 1925,                       /* -isysroot */
  OPT_isystem = 1926,                        /* -isystem */
  OPT_iwithprefix = 1927,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1928,              /* -iwithprefixbefore */
  OPT_k8 = 1929,                             /* -k8 */
  OPT_keep_private_externs = 1930,           /* -keep_private_externs */
  OPT_l = 1931,                              /* -l */
  OPT_lang_asm = 1932,                       /* -lang-asm */
  OPT_list = 1933,                           /* -list */
  /* OPT_m64 = 1934, */                      /* -m64 */
  OPT_mabi_ = 1935,                          /* -mabi= */
  OPT_march_ = 1936,                         /* -march= */
  OPT_matt_stubs = 1937,                     /* -matt-stubs */
  OPT_mbig_endian = 1938,                    /* -mbig-endian */
  OPT_mbranch_protection_ = 1939,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1940,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1941,            /* -mconstant-cfstrings */
  OPT_mcpu_ = 1942,                          /* -mcpu= */
  OPT_mdynamic_no_pic = 1943,                /* -mdynamic-no-pic */
  OPT_mfix_and_continue = 1944,              /* -mfix-and-continue */
  OPT_mfix_cortex_a53_835769 = 1945,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1946,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1947,             /* -mgeneral-regs-only */
  OPT_mharden_sls_ = 1948,                   /* -mharden-sls= */
  OPT_mkernel = 1949,                        /* -mkernel */
  OPT_mlittle_endian = 1950,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1951,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1952,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1953,            /* -mlow-precision-sqrt */
  OPT_mmacosx_version_min_ = 1954,           /* -mmacosx-version-min= */
  OPT_momit_leaf_frame_pointer = 1955,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1956,                 /* -mone-byte-bool */
  OPT_moutline_atomics = 1957,               /* -moutline-atomics */
  OPT_moverride_ = 1958,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1959,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1960,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1961, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1962,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1963,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1964,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1965,              /* -msve-vector-bits= */
  OPT_msymbol_stubs = 1966,                  /* -msymbol-stubs */
  OPT_mtarget_linker = 1967,                 /* -mtarget-linker */
  /* OPT_mtarget_linker_ = 1968, */          /* -mtarget-linker= */
  OPT_mtls_dialect_ = 1969,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1970,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1971,             /* -mtrack-speculation */
  OPT_mtune_ = 1972,                         /* -mtune= */
  OPT_multi_module = 1973,                   /* -multi_module */
  OPT_multiply_defined = 1974,               /* -multiply_defined */
  OPT_multiply_defined_unused = 1975,        /* -multiply_defined_unused */
  OPT_mverbose_cost_dump = 1976,             /* -mverbose-cost-dump */
  OPT_n = 1977,                              /* -n */
  OPT_name_sort = 1978,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1979,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1980,              /* -no-integrated-cpp */
  OPT_no_pie = 1981,                         /* -no-pie */
  OPT_no_dead_strip_inits_and_terms = 1982,  /* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1983,                          /* -nocpp */
  OPT_nodefaultexport = 1984,                /* -nodefaultexport */
  OPT_nodefaultlibs = 1985,                  /* -nodefaultlibs */
  OPT_nodefaultrpaths = 1986,                /* -nodefaultrpaths */
  OPT_nofixprebinding = 1987,                /* -nofixprebinding */
  OPT_nolibc = 1988,                         /* -nolibc */
  OPT_nomultidefs = 1989,                    /* -nomultidefs */
  OPT_nophoboslib = 1990,                    /* -nophoboslib */
  OPT_noprebind = 1991,                      /* -noprebind */
  OPT_noseglinkedit = 1992,                  /* -noseglinkedit */
  OPT_nostartfiles = 1993,                   /* -nostartfiles */
  OPT_nostdinc = 1994,                       /* -nostdinc */
  OPT_nostdinc__ = 1995,                     /* -nostdinc++ */
  OPT_nostdlib = 1996,                       /* -nostdlib */
  OPT_nostdlib__ = 1997,                     /* -nostdlib++ */
  OPT_o = 1998,                              /* -o */
  OPT_object = 1999,                         /* -object */
  OPT_objects = 2000,                        /* -objects */
  OPT_p = 2001,                              /* -p */
  OPT_pagezero_size = 2002,                  /* -pagezero_size */
  ...
  OPT_pie = 2007,                            /* -pie */
  OPT_pipe = 2008,                           /* -pipe */
  OPT_prebind = 2009,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 2010,   /* -prebind_all_twolevel_modules */
  OPT_preload = 2011,                        /* -preload */
  OPT_print_file_name_ = 2012,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2013,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2014,          /* -print-multi-directory */
  OPT_print_multi_lib = 2015,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2016,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2017,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2018,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2019,               /* -print-prog-name= */
  OPT_print_search_dirs = 2020,              /* -print-search-dirs */
  OPT_print_sysroot = 2021,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2022,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2023,                    /* -print-value */
  OPT_private_bundle = 2024,                 /* -private_bundle */
  OPT_pthread = 2025,                        /* -pthread */
  OPT_quiet = 2026,                          /* -quiet */
  OPT_r = 2027,                              /* -r */
  OPT_rdynamic = 2028,                       /* -rdynamic */
  OPT_read_only_relocs = 2029,               /* -read_only_relocs */
  OPT_remap = 2030,                          /* -remap */
  OPT_reverse_sort = 2031,                   /* -reverse-sort */
  OPT_rpath = 2032,                          /* -rpath */
  OPT_s = 2033,                              /* -s */
  OPT_save_temps = 2034,                     /* -save-temps */
  OPT_save_temps_ = 2035,                    /* -save-temps= */
  OPT_sectalign = 2036,                      /* -sectalign */
  OPT_sectcreate = 2037,                     /* -sectcreate */
  OPT_sectobjectsymbols = 2038,              /* -sectobjectsymbols */
  OPT_sectorder = 2039,                      /* -sectorder */
  OPT_seg1addr = 2040,                       /* -seg1addr */
  OPT_seg_addr_table = 2041,                 /* -seg_addr_table */
  OPT_seg_addr_table_filename = 2042,        /* -seg_addr_table_filename */
  OPT_segaddr = 2043,                        /* -segaddr */
  OPT_segcreate = 2044,                      /* -segcreate */
  OPT_seglinkedit = 2045,                    /* -seglinkedit */
  OPT_segprot = 2046,                        /* -segprot */
  OPT_segs_read_only_addr = 2047,            /* -segs_read_only_addr */
  OPT_segs_read_write_addr = 2048,           /* -segs_read_write_addr */
  OPT_shared = 2049,                         /* -shared */
  OPT_shared_libgcc = 2050,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2051,               /* -shared-libphobos */
  OPT_single_module = 2052,                  /* -single_module */
  OPT_size_sort = 2053,                      /* -size-sort */
  /* OPT_specs = 2054, */                    /* -specs */
  OPT_specs_ = 2055,                         /* -specs= */
  OPT_static = 2056,                         /* -static */
  OPT_static_libasan = 2057,                 /* -static-libasan */
  OPT_static_libgcc = 2058,                  /* -static-libgcc */
  OPT_static_libgfortran = 2059,             /* -static-libgfortran */
  OPT_static_libgm2 = 2060,                  /* -static-libgm2 */
  OPT_static_libgo = 2061,                   /* -static-libgo */
  OPT_static_libhwasan = 2062,               /* -static-libhwasan */
  OPT_static_liblsan = 2063,                 /* -static-liblsan */
  OPT_static_libmpx = 2064,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2065,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2066,               /* -static-libphobos */
  OPT_static_libquadmath = 2067,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2068,               /* -static-libstdc++ */
  OPT_static_libtsan = 2069,                 /* -static-libtsan */
  OPT_static_libubsan = 2070,                /* -static-libubsan */
  OPT_static_pie = 2071,                     /* -static-pie */
  /* OPT_std_c__03 = 2072, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2073, */                /* -std=c++0x */
  OPT_std_c__11 = 2074,                      /* -std=c++11 */
  OPT_std_c__14 = 2075,                      /* -std=c++14 */
  OPT_std_c__17 = 2076,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2077, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2078, */                /* -std=c++1z */
  OPT_std_c__20 = 2079,                      /* -std=c++20 */
  OPT_std_c__23 = 2080,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2081, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2082, */                /* -std=c++2b */
  OPT_std_c__98 = 2083,                      /* -std=c++98 */
  OPT_std_c11 = 2084,                        /* -std=c11 */
  OPT_std_c17 = 2085,                        /* -std=c17 */
  /* OPT_std_c18 = 2086, */                  /* -std=c18 */
  /* OPT_std_c1x = 2087, */                  /* -std=c1x */
  OPT_std_c2x = 2088,                        /* -std=c2x */
  /* OPT_std_c89 = 2089, */                  /* -std=c89 */
  OPT_std_c90 = 2090,                        /* -std=c90 */
  OPT_std_c99 = 2091,                        /* -std=c99 */
  /* OPT_std_c9x = 2092, */                  /* -std=c9x */
  OPT_std_f2003 = 2093,                      /* -std=f2003 */
  OPT_std_f2008 = 2094,                      /* -std=f2008 */
  OPT_std_f2008ts = 2095,                    /* -std=f2008ts */
  OPT_std_f2018 = 2096,                      /* -std=f2018 */
  OPT_std_f95 = 2097,                        /* -std=f95 */
  OPT_std_gnu = 2098,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2099, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2100, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2101,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2102,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2103,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2104, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2105, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2106,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2107,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2108, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2109, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2110,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2111,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2112,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2113, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2114, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2115,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2116, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2117,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2118,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2119, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2120, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2121,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2122, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2123, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2124, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2125, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2126, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2127,                     /* -std=legacy */
  OPT_stdlib_ = 2128,                        /* -stdlib= */
  OPT_sub_library = 2129,                    /* -sub_library */
  OPT_sub_umbrella = 2130,                   /* -sub_umbrella */
  OPT_symbol_ = 2131,                        /* -symbol= */
  OPT_symbolic = 2132,                       /* -symbolic */
  OPT_t = 2133,                              /* -t */
  OPT_time = 2134,                           /* -time */
  OPT_time_ = 2135,                          /* -time= */
  OPT_traditional = 2136,                    /* -traditional */
  OPT_traditional_cpp = 2137,                /* -traditional-cpp */
  OPT_tree_stats = 2138,                     /* -tree-stats */
  OPT_trigraphs = 2139,                      /* -trigraphs */
  OPT_twolevel_namespace = 2140,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 2141,       /* -twolevel_namespace_hints */
  OPT_type_stats = 2142,                     /* -type-stats */
  OPT_u = 2143,                              /* -u */
  OPT_umbrella = 2144,                       /* -umbrella */
  OPT_undef = 2145,                          /* -undef */
  OPT_undefined = 2146,                      /* -undefined */
  OPT_unexported_symbols_list = 2147,        /* -unexported_symbols_list */
  OPT_v = 2148,                              /* -v */
  OPT_version = 2149,                        /* -version */
  OPT_w = 2150,                              /* -w */
  OPT_weak_reference_mismatches = 2151,      /* -weak_reference_mismatches */
  OPT_whatsloaded = 2152,                    /* -whatsloaded */
  OPT_whyload = 2153,                        /* -whyload */
  OPT_wrapper = 2154,                        /* -wrapper */
  OPT_x = 2155,                              /* -x */
  OPT_y = 2156,                              /* -y */
  OPT_z = 2157,                              /* -z */
  N_OPTS,
